...
<div class="cards-wrapper">
  <div class="card">
    ...
    <h4 class="title">🧭 Aplicar os Princípios Universalmente</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🧭 Gerenciar Exceções Arquiteturais Corporativas</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🧭 Governança de API deve promover o alinhamento entre o negócio e a TI</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🧭 Contrato da API compliance com o negócio</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🧭 Padronização com Arquitetura da API</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🧭 Visibilidade e Rastreabilidade das APIs</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🧭 Reuso de APIs</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🧭 Segurança de dados by design</h4>
  </div>
</div>
...
<!-- Onboarding -->
<h3 class="highlighted-title">▶️ 1 - Onboarding<h3>
...
<div class="cards-wrapper">
  <div class="card">
    <div class="preview"></div>
    <h4 class="title">📌 Diretriz: Contrato de API</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">📄 Template: OpenAPI Specification</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🔑 Conceito: Modelagem de APIs por Domínio</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🔑 Prática: Decomposição de Processos de NEgócios para Hiperlinks</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🔑 Prática: WebHooks</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🔑 Prática: Design de APIs com Workflows</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">📌 Diretriz: Segurança</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🔑 Prática: Estratégia da API</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">📄 Template: Especificação de API</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">✅ Checklist: Revisão das APIs</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">📄 Template: Data MApping</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🔑 Prática: Teste de APIs</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">📌 Diretriz: Política de Versionamento de APIs</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🔑 Prática: Indicadores de Negócio de APIs</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">🔑 Prática: HATEOAS</h4>
  </div>
</div>
...
<div class="cards-wrapper">
  <div class="card">
    <div class="preview"></div>
    <h4 class="title">▶️ Onboarding de novos times</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">▶️ Capacitação e Apoio consultivo</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">▶️ Revisões e Desenho da Solução</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">▶️ Processo de Crianção de API no API Sensedia Manager</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">▶️ Métricas e Melhoria Contínua</h4>
  </div>

  <div class="card">
    <div class="preview"></div>
    <h4 class="title">▶️ Gestão de Exceções</h4>
  </div>
</div>
